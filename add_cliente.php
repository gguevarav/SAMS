...
$domicilio=test_input(strtoupper($_POST['direccion']));
$ciudad=test_input(strtoupper($_POST['municipio']));

$create="insert into clientes(nombre,telefono,direccion,municipio) values
('$nombre','$telefono','$direccion','$municipio')";
