...
function sumatorias(){
  $(document).ready(function(){
    ...
    $('#tabla_ventas_credito > tbody > tr').each(function(){
         ...
         $("#total_credito").html("");
         $("#total_credito").html("<span class='label label-success'>Total: Q. "+total_credito.toFixed(2)+"</span> | <span class='label label-success'>Cancelaciones: Q. "+detalle_cancelado.toFixed(2)+"</span> | <span class='label label-danger'>Venta Neta: Q. "+detalle.toFixed(2)+"</span>");
        });
       /*tabla de contado*/
        ...
        $('#tabla_ventas_contado > tbody > tr').each(function(){
         ...
         $("#total_contado").html("");
         $("#total_contado").html("<span class='label label-success'>Total: Q. "+total_contado.toFixed(2)+"</span> | <span class='label label-success'>Cancelaciones: Q. "+detalle_cancelado_contado.toFixed(2)+"</span> | <span class='label label-danger'>Venta Neta: Q. "+detalle_contado.toFixed(2)+"</span>");
        });
        ...
        /*tabla de gastos
         ...
         $("#total_de_los_gastos").html("<span class='label label-success'>Total: Q. "+total_gastos.toFixed(2)+"</span>");
        });*/
        ...
        /*tabla de abonos*/
         ...
         $("#total_de_los_abonos").html("<span class='label label-success'>Total: Q. "+total_abonos.toFixed(2)+"</span>");
        });
        var venta_neta=detalle_contado+detalle;

       $("#global").html("<div class='callout callout-success'><h3>Venta: Q."+venta_neta.toFixed(2)+"<br>"+
       "Cancelaciones: Q."+(detalle_cancelado_contado+detalle_cancelado)+"<br>"+
       "Abonos de Clientes: Q."+total_abonos+"<br>"+
       "Total en Caja: Q."+((total_contado+total_abonos-total_gastos).toFixed(2))+"<h3></div>");
     })
}
/*********************************************************************************************/
function print1(){
