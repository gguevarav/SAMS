      ...
      <div class="content-wrapper">
        ...
        <section class="content">
         ...
         <form class='horizontal' onkeypress="return pulsar(event)">
          ...
          <span class='input-group-addon bg-red'>Contraseña:</span>
         ...
         <button type='button' class='btn btn-primary pull-right' onclick="valida_acceso();" id='btn-valida'><i></i> Aceptar</button>
         </div>
         </div>
         </div>
        </section><!-- /.content -->
