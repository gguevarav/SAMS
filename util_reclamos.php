      ...
      <div class="content-wrapper">
        ...
        <section class="content">
         ...
         <div class="form-group">
                    ...
                    <div class='form-group'>
                    <label for="codigostock" class="col-sm-2 control-label">Descripcion del Reclamo:</label>
                    <div class="col-sm-6">
                    <input type="text" class="form-control" id='descripcion' placeholder='Descripcion del reclamo...'>
                    </div>
                    </div>
         ...
         <button type="button" class="btn btn-success pull-right" onclick="procesa_reclamacion();" id="btn-termina"><i class='fa fa-print'></i> Imprimir Ticket</button>
         <button class='btn btn-success hidden print_ticket' id='btn-termina' onclick='' disabled></button>
         </div>
         </div>
         </div>
