  ...
  public function ConexionMySQL(){
    if(!isset($this->conexion)){
      $this->conexion = (mysql_connect("localhost","root",""))
        or die("No se pudo establecer una conexion con el servidor");
      mysql_select_db("db_puntoventa",$this->conexion) or die("Ocurrio un problema al seleccionar la base de datos");
    }
  }
