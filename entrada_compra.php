...
<html>
  ...
  <body onload="pone_num_entrada();lista_proveedores();revisa_entrada_ini();">
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Almacen | Entradas
            <small><div style='color: #C20300'></div></small>
          </h1>
        </section>
          ...
          <div class='col-md-4'>
           ...
           <div class='box-body'>
            ...
            <div class='input-group'>
             <span class='input-group-addon bg-red'>Proveedor:</span>
             <div id='pone_provs'></div>
            </div>
            <br>
            <div class='input-group'>
             <span class='input-group-addon bg-red'><i class="fa fa-calendar"></i> Fecha:</span>
             <input type="text" class="form-control pull-right" id="fecha" onchange="actualiza_fecha_temp();" autocomplete="off">
            </div>
             <br>
            <div class='input-group'>
            <span class='input-group-addon bg-red'><i class="fa fa-sticky-note-o"></i> Factura:</span>
             <input type="text" class="form-control" id="factura" onchange="actualiza_num_fac_entrada_temp();">
            </div>
            <br>
            <div class='input-group'>
             <span class='input-group-addon bg-red'><i class="fa fa-database"></i> IVA:</span>
             ...
             <option value='12'>12 % de Impuesto</option>
           </select>
            </div>
            <br>
            <div class='input-group'>
             <span class='input-group-addon bg-red'><i class="fa fa-plus"></i> % Descuento:</span>
           ...
           <div class='box-body'>
           <div class='input-group'>
             <span class='input-group-addon bg-red'><i class="fa fa-barcode"></i> Codigo:</span>
            ...
            <br>
            <div class='input-group'>
             <span class='input-group-addon bg-red'><i class="fa fa-code"></i> Descuento:</span>
             <input type="text" class="form-control pull-right" id="descripcion" value='' disabled>
            </div>
            <br>
            <div class='input-group'>
             <span class='input-group-addon bg-red'><i class=""></i> Costo:</span>
             <input type="text" class="form-control pull-right cantidades" id="costo"
             data-inputmask="'alias': 'numeric', 'autoGroup': true, 'digits': 2, 'digitsOptional': false, 'placeholder': '"
             style="font-size:20px; text-align:center; color:blue; font-weight: bold;" disabled>
            </div>
            <br>
            <div class='input-group'>
             <span class='input-group-addon bg-red'><i class="fa fa-calculator"></i> Cantidad:</span>
             <input type="text" class="form-control pull-right cantidades" id="cantidad"
             data-inputmask="'alias': 'numeric', 'autoGroup': true, 'digits': 2, 'digitsOptional': false, 'placeholder': '0"
             style="font-size:20px; text-align:center; color:red; font-weight: bold;" disabled>
            </div>
            <br>
            <div class='btn-group'>
           ...
           <div class='box-header with-border'>
            <div class='btn-group'>
           <button class='btn btn-primary' type='button' onclick='procesa_entrada();' id='btn-procesa' disabled><i class='fa fa-external-link'></i> Ingresar entrada.</button>
           ...
           <div class='box-body'>
           <div class='input-group'>
             <span class='input-group-addon bg-red'><i class="fa fa-file-text-o"></i> Total:</span>
             <input type="text" class="form-control pull-right" id="net" value=''
             style="font-size:20px; text-align:center; color:blue; font-weight: bold;" disabled>
</div>
             <span class='input-group-addon bg-red'>Q. Descuento:</span>
             <input type="text" class="form-control pull-right" id="des" value=''
             style="font-size:20px; text-align:center; color:blue; font-weight: bold;" disabled>
           </div>

            <div class='input-group'>
             <span class='input-group-addon bg-red'><i class="fa  fa-repeat"></i> Monto + IVA:</span>
             <input type="text" class="form-control pull-right" id="tot" value=''
             style="font-size:20px; text-align:center; color:blue; font-weight: bold;" disabled>
           </div>

            <div class='input-group'>
             <span class='input-group-addon bg-red'><i class="fa fa-list-ol"></i> Articulos:</span>
    ...
    $(window).bind('beforeunload', function(){
         return 'Deseas salir de Entradas ';
        });
    });
    </script>
  </body>
