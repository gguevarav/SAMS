...
$periodogarantia=test_input($_POST['periodogarantia']);
...
$cadena_insert=$db->consulta("Insert into garantias(idfactura,fechacompra,fechavence) values('$numero_ticket',now(),DATE_ADD(now(), INTERVAL $periodogarantia YEAR))");
