          ...
          <div class='row'>
           <div class='col-md-12'>
             <div class='nav-tabs-custom'>
                  ...
                  <li class="active"><a href="#altas" data-toggle="tab">Agrear</a></li>
               ...
               <div class="tab-content">
                  ...
                  <div class="tab-pane" id="bajas">
                    ...
                    <label for="linea" class="col-sm-2 control-label">Linea:</label>
                    <div class="col-sm-2">
                    <input type="text" class="form-control" id='linea_baja' placeholder='# Linea' onblur="busca_linea();"
                    data-inputmask="'alias': , 'autoGroup': true, , 'digitsOptional': true">
                    <br>
                    ...
                    <label for="grupo" class="col-sm-2 control-label">Grupo:</label>
                    <div class="col-sm-2">
                    <input type="text" class="form-control" id='grupo_baja' placeholder='# Grupo' onblur="busca_grupo();"
                    data-inputmask="'alias':  'autoGroup': true, 'digitsOptional': true" disabled>
                    <br>
                    ...
                    <br>
                    <div class="btn-group">
                    <button type='button' class='btn btn-danger btn-lg' onclick='procesa_lineas_baja();pone_lista_lineas();' id='btn-bajas' disabled><i class='fa fa-check-circle'></i> Eliminar.</button>
                    </div>
                    </form>
                  </div><!-- /.tab-pane -->
